...
export function ProfileScreen({ profile, journeys, today, entries, moderator, onOpenSection, onOpenLibrary, onOpenPublicResources, onOpenFeedback, onOpenMessages, onOpenModeration }: { profile: AccountProfile; journeys: Journey[]; today: Today; entries: GrowthEntry[]; moderator: boolean; onOpenSection: (section: ProfileSection) => void; onOpenLibrary: () => void; onOpenPublicResources: () => void; onOpenFeedback: () => void; onOpenMessages: () => void; onOpenModeration: () => void }) {
