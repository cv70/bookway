import { ArrowUpRight, Ban, Mail, UserPlus, VolumeX, X } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  ...
  messageButton: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderRadius: 5, backgroundColor: colors.evergreenSoft },
