...
pub(crate) use ranker::RemoteModelRanker;
...
pub(crate) use source::{ContentCandidateSource, SourceStrategy};

use crate::internal::datasource::{
    BbsClientError, BbsLinkClientError, LikeStatusClientError, ModelClientError,
};

#[derive(Clone, Debug)]
pub(crate) struct FeedQuery {
    interests: HashSet<GrowthDomainDto>,
    seen: HashSet<String>,
    user_id: String,
    session_id: String,
    surface: String,
...
pub(crate) enum PipelineError {
    #[error(transparent)]
    BbsLink(#[from] BbsLinkClientError),
    #[error(transparent)]
